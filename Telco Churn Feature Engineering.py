...
df = pd.read_csv("C:/Users/Enes Fevzi/Desktop/Machine Learning/Bonus II/telcoChurn-221211-022343 (1)/telcoChurn/Telco-Customer-Churn.csv")
df.head()
df.shape
df.info()
...
def grab_col_names(dataframe, cat_th=10, car_th=20):
    ...
    cat_but_car = [col for col in dataframe.columns if dataframe[col].nunique() > car_th and dataframe[col].dtypes == "O"] #object ise
